...
public class Main {
    ...
    private static void categoryInput(List<Category> categoryList) {
    ...
    private static void paramStoreInput(Scanner input, List<Item> itemList, List<Store> listOfTehnicalStores , List<Store> listOfFoodStores, List<Store> storeList) {
        ...
        TehnicalStore<Tehnical> newTehnicalStore = new TehnicalStore<>(tehnicalStoreName, 1,"hardkodiraniWeb",listOfTehnicalItems);
        ...
        FoodStore<Edible> newFoodStore = new FoodStore<>(edibleStoreName,  1,"hardkodiraniWeb",listOfTehnicalItems);
